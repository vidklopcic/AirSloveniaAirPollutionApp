...
import com.citisense.vidklopcic.citisense.data.Serializers.ARSOMeasurements;
                ...
                while (true) {
                    ...
                    try {
                        ...
                        for (ARSOStation station : measurements.stations) {
                            ...
                            if (mstat != null && new Date().getTime() - mstat.getLastUpdateTime()
                                    > Constants.ARSOStation.update_interval || mForceUpdate) {
                                notifyStationUpdated(MeasuringStation.updateOrCreate(realm, station));
                                updated = true;
                            }
                        }
//                        for (com.citisense.vidklopcic.citisense.data.Serializers.ARSOStation arso : measurements.stations) {
